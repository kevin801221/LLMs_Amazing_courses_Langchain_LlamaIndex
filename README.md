...
## Latest Updates
 - **2025/2/6 NewestRAG_Agent_course_folder** - Added the latest RAG_Agent_course_folder, which includes the latest RAG and Agent technologies and applications. It also includes applications for web data crawling using firecrawl and jina.
